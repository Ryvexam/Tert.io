...
{
    #[Route("/moyens-et-methodes", name: "app_moyens_methodes")]
    function moyens()
    {
        return $this->render("Formation/moyensmethodes.html.twig");
    }

    #[Route("/nos-resultats", name: "app_resultats")]
    function resultats()
    {
        return $this->render("Formation/resultats.html.twig");
    }
